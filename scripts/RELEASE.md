...
sign_update /tmp/MachStruct-v1.1.dmg
```
...
<item>
  ...
  <enclosure
    url="https://github.com/lustech/MachStruct/releases/download/v1.1/MachStruct-v1.1.dmg"
...
| Sign for Sparkle | `sign_update /tmp/MachStruct-vX.Y.dmg` |
